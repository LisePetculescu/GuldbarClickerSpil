...
function displayMinusLife() {
    ...
    document.querySelector("#heart_sprite").classList.remove("addLife");
    document.querySelector("#heart_sprite").classList.add("loseLife");
}
...
function displayPlusLife() {
    document.querySelector("#heart_sprite").classList.remove("loseLife");
    document.querySelector("#heart_sprite").classList.add("addLife");
}
